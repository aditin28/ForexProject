...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ExceptionDTO> handleUserBankDetailsNotFoundException(UserBankDetailsNotFoundException e) {
		return  new ResponseEntity<>(new ExceptionDTO(e.getMessage()),HttpStatus.NOT_FOUND);
	}

	@ExceptionHandler(InvalidAccountException.class)
	public ResponseEntity<ExceptionDTO> handleInvalidAccountException(InvalidAccountException e) {
		return  new ResponseEntity<>(new ExceptionDTO(e.getMessage()),HttpStatus.NOT_FOUND);
	}
	...
	@ExceptionHandler(UsersEmailNotExistingException.class)
	 public ResponseEntity<ExceptionDTO> handleUsersEmailNotExistingException(UsersEmailNotExistingException e) {
		return  new ResponseEntity<>(new ExceptionDTO(e.getMessage()),HttpStatus.NOT_FOUND);
 }
