...
public class UserBankDetailsController {
	...
	public ResponseEntity<CommonDTO<APIResponsedto>> addBankDetails(@Valid @RequestBody UserBankDetailsDto userBankDetails )
	{
		APIResponsedto newUserBankDetails = iUserBankDetails.saveBankDetails(userBankDetails);
