...
public class IUserBankDetailsServiceImpl implements IUserBankDetailsService {
    ...
    public UserBankDetails findByUserId(int userId) {
        ...
        return iUserBankDetailsRepository.findByUserUsersId(userId);
    }
    ...
    public APIResponsedto saveBankDetails(UserBankDetailsDto bankDto) {
        ...
        UsersDto usersdto = apiClient.fetchUsersDetails(bankDto.getUserId());
        APIResponsedto apiresponsedto = new APIResponsedto();
        apiresponsedto.setUser(usersdto);
        ...
        apiresponsedto.setUserbankdetails(bankDto);
    ...
    public UserBankDetailsDto updateBankDetails(UserBankDetailsDto bankDto) {
        ...
        UserBankDetails obj = iUserBankDetailsRepository.findByUserUsersId(user.getUsersId());
        obj.setAccountHolderName(bankDto.getAccountHolderName());
        obj.setBankName(bankDto.getBankName());
